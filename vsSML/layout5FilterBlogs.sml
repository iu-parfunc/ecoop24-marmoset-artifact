...
fun mkBlogs_layout5 (length_57_2524_3911 , contlen_58_2525_3912, taglen_59_2526_3913) = 
  let val fltIf_3829_3914 = (length_57_2524_3911 <= 0) in 
  (if fltIf_3829_3914 then End 
   else 
  let val fltAppE_3830_3915 = (length_57_2524_3911 - 1) in 
  let val rst_60_2527_3916 = (mkBlogs_layout5(fltAppE_3830_3915 , contlen_58_2525_3912, taglen_59_2526_3913)) in 
  let val fltPkd_3831_3917 = (mkSomeTags taglen_59_2526_3913) in 
  let val tags_61_2528_3918 = (TagList (fltPkd_3831_3917)) in 
  let val fltPkd_3833_3919 = (mkRandomInlineList contlen_58_2525_3912) in 
  let val fltPkd_3832_3920 = (Plain (fltPkd_3833_3919)) in 
  let val content_62_2529_3921 = (Content (fltPkd_3832_3920)) in 
  ...
  let val date_66_2533_3930 = (Date (fltPkd_3838_3929)) in (Layout5 (rst_60_2527_3916 , tags_61_2528_3918, content_62_2529_3921, header_63_2530_3923, id_64_2531_3926, author_65_2532_3928, date_66_2533_3930)) end end end end end end end end end end end end end end end end) end;
...
fun checkBlogs (keyword_44_2511_3897 , blogs_45_2512_3898) = (case blogs_45_2512_3898 of End => true 
  | Layout5 (rst_46_2513_3899 , tags_47_2514_3900, content_48_2515_3901, header_49_2516_3902, id_50_2517_3903, author_51_2518_3904, date_52_2519_3905) => 
  let val present_53_2520_3906 = (searchBlogTags(keyword_44_2511_3897 , tags_47_2514_3900)) in 
  let val fltPrm_3828_3907 = (checkBlogs(keyword_44_2511_3897 , rst_46_2513_3899)) in (present_53_2520_3906 andalso fltPrm_3828_3907) end end);

fun filterByKeywordInTagList (keyword_33_2500_3886 , blogs_34_2501_3887) = (case blogs_34_2501_3887 of End => End 
  | Layout5 (rst_35_2502_3888 , tags_36_2503_3889, content_37_2504_3890, header_38_2505_3891, id_39_2506_3892, author_40_2507_3893, date_41_2508_3894) => 
  let val present_42_2509_3895 = (searchBlogTags(keyword_33_2500_3886 , tags_36_2503_3889)) in 
  (if present_42_2509_3895 then 
  let val newRst_43_2510_3896 = (filterByKeywordInTagList(keyword_33_2500_3886 , rst_35_2502_3888)) in (Layout5 (newRst_43_2510_3896 , tags_36_2503_3889, content_37_2504_3890, header_38_2505_3891, id_39_2506_3892, author_40_2507_3893, date_41_2508_3894)) end 
   else (filterByKeywordInTagList(keyword_33_2500_3886 , rst_35_2502_3888))) end);
val _ = ((fn true => print "True" | false => print "False") 
  let val blogs_27_2495_3881 = (mkBlogs_layout5(1000000 , 500, 5)) in 
