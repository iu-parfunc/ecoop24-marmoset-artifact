...
fun mkBlogs_layout3 (length_105_2567_3973 , contlen_106_2568_3974, taglen_107_2569_3975) = 
  let val fltIf_3825_3976 = (length_105_2567_3973 <= 0) in 
  (if fltIf_3825_3976 then End 
   else 
  let val fltPkd_3826_3977 = (mkSomeTags taglen_107_2569_3975) in 
  let val tags_108_2570_3978 = (TagList (fltPkd_3826_3977)) in 
  let val fltAppE_3827_3979 = (length_105_2567_3973 - 1) in 
  let val rst_109_2571_3980 = (mkBlogs_layout3(fltAppE_3827_3979 , contlen_106_2568_3974, taglen_107_2569_3975)) in 
  let val fltPkd_3829_3981 = (mkRandomInlineList contlen_106_2568_3974) in 
  let val fltPkd_3828_3982 = (Plain (fltPkd_3829_3981)) in 
  let val content_110_2572_3983 = (Content (fltPkd_3828_3982)) in 
  ...
  let val date_114_2576_3992 = (Date (fltPkd_3834_3991)) in (Layout3 (tags_108_2570_3978 , rst_109_2571_3980, content_110_2572_3983, header_111_2573_3985, id_112_2574_3988, author_113_2575_3990, date_114_2576_3992)) end end end end end end end end end end end end end end end end) end;
...
fun caseFn_2483 (keyword_28_2484_3703_4827 , content_32_2485_3704_4828) = (case content_32_2485_3704_4828 of Content (block_38_3705_4829) => 
...
fun emphKeywordInTag (keyword_28_2491_3888 , blogs_29_2492_3889) = (case blogs_29_2492_3889 of End => End 
  | Layout3 (tags_30_2493_3890 , rst_31_2494_3891, content_32_2495_3892, header_33_2496_3893, id_34_2497_3894, author_35_2498_3895, date_36_2499_3896) => 
  let val present_37_2500_3897 = (searchBlogTags(keyword_28_2491_3888 , tags_30_2493_3890)) in 
  (if present_37_2500_3897 then 
  let val newContent_39_2501_3898 = (caseFn_2483(keyword_28_2491_3888 , content_32_2495_3892)) in 
  let val newRst_40_2502_3899 = (emphKeywordInTag(keyword_28_2491_3888 , rst_31_2494_3891)) in (Layout3 (tags_30_2493_3890 , newRst_40_2502_3899, newContent_39_2501_3898, header_33_2496_3893, id_34_2497_3894, author_35_2498_3895, date_36_2499_3896)) end end 
   else 
  let val newRst_41_2503_3900 = (emphKeywordInTag(keyword_28_2491_3888 , rst_31_2494_3891)) in (Layout3 (tags_30_2493_3890 , newRst_41_2503_3900, content_32_2495_3892, header_33_2496_3893, id_34_2497_3894, author_35_2498_3895, date_36_2499_3896)) end) end);
val _ = ((fn true => print "True" | false => print "False") 
  let val blogs_22_2486_3881 = (mkBlogs_layout3(400000 , 500, 5)) in 
