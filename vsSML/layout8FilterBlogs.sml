datatype dat_Inline = Str of (char ArraySlice.slice) | Emph of ( dat_PList_v_1084)| Space 
...
and dat_PList_v_1085 = Nil_v_1085 | Cons_v_1085 of (char ArraySlice.slice  *  dat_PList_v_1085)
...
fun cmp (start_330_2772_3976 , end_331_2773_3977, word1_332_2774_3978, word2_333_2775_3979) = 
  ...
  let val a_334_2776_3983 = (ArraySlice.sub(word1_332_2774_3978 , start_330_2772_3976)) in 
  let val b_335_2777_3986 = (ArraySlice.sub(word2_333_2775_3979 , start_330_2772_3976)) in 
...
fun compareWord (word1_338_2780_3991 , word2_339_2781_3992) = 
  let val len1_340_2782_3994 = (ArraySlice.length word1_338_2780_3991) in 
  let val len2_341_2783_3996 = (ArraySlice.length word2_339_2781_3992) in 
...
fun mkSomeTags (len_205_2667_3957) = 
  ...
  let val vec_220_206_2668_3959 = ((fn internal__ => ArraySlice.full(Array.array(internal__, 0))) 1) in 
  let val internal__207_2669_3960 = let val _ = (ArraySlice.update(vec_220_206_2668_3959 , 0, a)) in vec_220_206_2668_3959 end in 
...
fun mkChar (val_377_2819_4004) = 
  let val fltPrm_3876_4005 = (MltonRandom.rand()) in 
...
fun generate_loop_1097_1588 (vec_633_2977_4010 , idx_634_2978_4011, end_635_2979_4012) = 
  ...
  let val vec1_638_2980_4015 = let val _ = (ArraySlice.update(vec_633_2977_4010 , idx_634_2978_4011, fltPrm_3879_4014)) in vec_633_2977_4010 end in 
...
fun getRandomString (length_376_2818_3999) = 
  ...
  let val vec_382_2975_3766_4002 = ((fn internal__ => ArraySlice.full(Array.array(internal__, 0))) n__381_2974_3765_4001) in 
...
fun mkBlogs_layout8 (length_57_2524_3911 , contlen_58_2525_3912, taglen_59_2526_3913) = 
  let val fltIf_3829_3914 = (length_57_2524_3911 <= 0) in 
  (if fltIf_3829_3914 then End 
   else 
  let val fltPkd_3831_3915 = (mkRandomInlineList contlen_58_2525_3912) in 
  let val fltPkd_3830_3916 = (Plain (fltPkd_3831_3915)) in 
  let val content_60_2527_3917 = (Content (fltPkd_3830_3916)) in 
  let val fltAppE_3832_3918 = (length_57_2524_3911 - 1) in 
  let val rst_61_2528_3919 = (mkBlogs_layout8(fltAppE_3832_3918 , contlen_58_2525_3912, taglen_59_2526_3913)) in 
  let val fltPrm_3834_3920 = (length_57_2524_3911 mod 10) in 
  let val fltPkd_3833_3921 = (10 - fltPrm_3834_3920) in 
  let val id_62_2529_3922 = (ID (fltPkd_3833_3921)) in 
  let val fltPkd_3835_3923 = (getRandomString 5) in 
  let val author_63_2530_3924 = (Author (fltPkd_3835_3923)) in 
  let val fltPkd_3836_3925 = (getRandomString 5) in 
  let val date_64_2531_3926 = (Date (fltPkd_3836_3925)) in 
  let val fltPkd_3837_3927 = (getRandomString 5) in 
  let val header_65_2532_3928 = (Header (fltPkd_3837_3927)) in 
  let val fltPkd_3838_3929 = (mkSomeTags taglen_59_2526_3913) in 
  let val tags_66_2533_3930 = (TagList (fltPkd_3838_3929)) in (Layout8 (content_60_2527_3917 , rst_61_2528_3919, id_62_2529_3922, author_63_2530_3924, date_64_2531_3926, header_65_2532_3928, tags_66_2533_3930)) end end end end end end end end end end end end end end end end) end;
...
fun checkBlogs (keyword_44_2511_3897 , blogs_45_2512_3898) = (case blogs_45_2512_3898 of End => true 
  | Layout8 (content_46_2513_3899 , rst_47_2514_3900, id_48_2515_3901, author_49_2516_3902, date_50_2517_3903, header_51_2518_3904, tags_52_2519_3905) => 
  let val present_53_2520_3906 = (searchBlogTags(keyword_44_2511_3897 , tags_52_2519_3905)) in 
  let val fltPrm_3828_3907 = (checkBlogs(keyword_44_2511_3897 , rst_47_2514_3900)) in (present_53_2520_3906 andalso fltPrm_3828_3907) end end);

fun filterByKeywordInTagList (keyword_33_2500_3886 , blogs_34_2501_3887) = (case blogs_34_2501_3887 of End => End 
  | Layout8 (content_35_2502_3888 , rst_36_2503_3889, id_37_2504_3890, author_38_2505_3891, date_39_2506_3892, header_40_2507_3893, tags_41_2508_3894) => 
  let val present_42_2509_3895 = (searchBlogTags(keyword_33_2500_3886 , tags_41_2508_3894)) in 
  (if present_42_2509_3895 then 
  let val newRst_43_2510_3896 = (filterByKeywordInTagList(keyword_33_2500_3886 , rst_36_2503_3889)) in (Layout8 (content_35_2502_3888 , newRst_43_2510_3896, id_37_2504_3890, author_38_2505_3891, date_39_2506_3892, header_40_2507_3893, tags_41_2508_3894)) end 
   else (filterByKeywordInTagList(keyword_33_2500_3886 , rst_36_2503_3889))) end);
val _ = ((fn true => print "True" | false => print "False") 
  let val blogs_27_2495_3881 = (mkBlogs_layout8(1000000 , 500, 5)) in 
  let val vec_24_28_2496_3882 = ((fn internal__ => ArraySlice.full(Array.array(internal__, 0))) 1) in 
  let val internal__29_2497_3883 = let val _ = (ArraySlice.update(vec_24_28_2496_3882 , 0, a)) in vec_24_28_2496_3882 end in 
