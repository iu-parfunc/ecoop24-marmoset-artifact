...
fun mkBlogs_layout1 (length_57_2524_3911 , contlen_58_2525_3912, taglen_59_2526_3913) = 
  let val fltIf_3829_3914 = (length_57_2524_3911 <= 0) in 
  (if fltIf_3829_3914 then End 
   else 
  let val fltPkd_3830_3915 = (getRandomString 5) in 
  let val header_60_2527_3916 = (Header (fltPkd_3830_3915)) in 
  let val fltPrm_3832_3917 = (length_57_2524_3911 mod 10) in 
  let val fltPkd_3831_3918 = (10 - fltPrm_3832_3917) in 
  let val id_61_2528_3919 = (ID (fltPkd_3831_3918)) in 
  let val fltPkd_3833_3920 = (getRandomString 5) in 
  let val author_62_2529_3921 = (Author (fltPkd_3833_3920)) in 
  let val fltPkd_3834_3922 = (getRandomString 5) in 
  let val date_63_2530_3923 = (Date (fltPkd_3834_3922)) in 
  let val fltPkd_3836_3924 = (mkRandomInlineList contlen_58_2525_3912) in 
  let val fltPkd_3835_3925 = (Plain (fltPkd_3836_3924)) in 
  let val content_64_2531_3926 = (Content (fltPkd_3835_3925)) in 
  let val fltPkd_3837_3927 = (mkSomeTags taglen_59_2526_3913) in 
  let val tags_65_2532_3928 = (TagList (fltPkd_3837_3927)) in 
  let val fltAppE_3838_3929 = (length_57_2524_3911 - 1) in 
  let val rst_66_2533_3930 = (mkBlogs_layout1(fltAppE_3838_3929 , contlen_58_2525_3912, taglen_59_2526_3913)) in (Layout1 (header_60_2527_3916 , id_61_2528_3919, author_62_2529_3921, date_63_2530_3923, content_64_2531_3926, tags_65_2532_3928, rst_66_2533_3930)) end end end end end end end end end end end end end end end end) end;
...
fun checkBlogs (keyword_44_2511_3897 , blogs_45_2512_3898) = (case blogs_45_2512_3898 of End => true 
  | Layout1 (header_46_2513_3899 , id_47_2514_3900, author_48_2515_3901, date_49_2516_3902, content_50_2517_3903, tags_51_2518_3904, rst_52_2519_3905) => 
  let val present_53_2520_3906 = (searchBlogTags(keyword_44_2511_3897 , tags_51_2518_3904)) in 
  let val fltPrm_3828_3907 = (checkBlogs(keyword_44_2511_3897 , rst_52_2519_3905)) in (present_53_2520_3906 andalso fltPrm_3828_3907) end end);

fun filterByKeywordInTagList (keyword_33_2500_3886 , blogs_34_2501_3887) = (case blogs_34_2501_3887 of End => End 
  | Layout1 (header_35_2502_3888 , id_36_2503_3889, author_37_2504_3890, date_38_2505_3891, content_39_2506_3892, tags_40_2507_3893, rst_41_2508_3894) => 
  let val present_42_2509_3895 = (searchBlogTags(keyword_33_2500_3886 , tags_40_2507_3893)) in 
  (if present_42_2509_3895 then 
  let val newRst_43_2510_3896 = (filterByKeywordInTagList(keyword_33_2500_3886 , rst_41_2508_3894)) in (Layout1 (header_35_2502_3888 , id_36_2503_3889, author_37_2504_3890, date_38_2505_3891, content_39_2506_3892, tags_40_2507_3893, newRst_43_2510_3896)) end 
