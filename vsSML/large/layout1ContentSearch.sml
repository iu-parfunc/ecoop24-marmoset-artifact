...
fun mkBlogs_layout1 (length_97_2545_3945 , contlen_98_2546_3946, taglen_99_2547_3947) = 
  let val fltIf_3805_3948 = (length_97_2545_3945 <= 0) in 
  (if fltIf_3805_3948 then End 
   else 
  let val fltPkd_3806_3949 = (getRandomString 5) in 
  let val header_100_2548_3950 = (Header (fltPkd_3806_3949)) in 
  let val fltPrm_3808_3951 = (length_97_2545_3945 mod 10) in 
  let val fltPkd_3807_3952 = (10 - fltPrm_3808_3951) in 
  let val id_101_2549_3953 = (ID (fltPkd_3807_3952)) in 
  let val fltPkd_3809_3954 = (getRandomString 5) in 
  let val author_102_2550_3955 = (Author (fltPkd_3809_3954)) in 
  let val fltPkd_3810_3956 = (getRandomString 5) in 
  let val date_103_2551_3957 = (Date (fltPkd_3810_3956)) in 
  let val fltPkd_3812_3958 = (mkRandomInlineList contlen_98_2546_3946) in 
  let val fltPkd_3811_3959 = (Plain (fltPkd_3812_3958)) in 
  let val content_104_2552_3960 = (Content (fltPkd_3811_3959)) in 
  let val fltPkd_3813_3961 = (mkSomeTags taglen_99_2547_3947) in 
  let val tags_105_2553_3962 = (TagList (fltPkd_3813_3961)) in 
  let val fltAppE_3814_3963 = (length_97_2545_3945 - 1) in 
  let val rst_106_2554_3964 = (mkBlogs_layout1(fltAppE_3814_3963 , contlen_98_2546_3946, taglen_99_2547_3947)) in (Layout1 (header_100_2548_3950 , id_101_2549_3953, author_102_2550_3955, date_103_2551_3957, content_104_2552_3960, tags_105_2553_3962, rst_106_2554_3964)) end end end end end end end end end end end end end end end end) end;
...
fun caseFn_2466 (keyword_25_2467_3684_4793 , content_31_2468_3685_4794) = (case content_31_2468_3685_4794 of Content (block_34_3686_4795) => 
...
fun emphKeywordInContent (keyword_25_2474_3865 , blogs_26_2475_3866) = (case blogs_26_2475_3866 of End => End 
  ...
  | Layout1 (header_27_2476_3867 , id_28_2477_3868, author_29_2478_3869, date_30_2479_3870, content_31_2480_3871, tags_32_2481_3872, rst_33_2482_3873) => 
  let val newContent_35_2483_3874 = (caseFn_2466(keyword_25_2474_3865 , content_31_2480_3871)) in 
...
val _ = ((fn true => print "True" | false => print "False") 
  ...
  let val _ = print "\n" in 
  let val fltPrm_3795_3864 = (blogLength newblgs_23_2473_3863) in
    (fltPrm_3795_3864 = 1000000) end end end end end end end end end end end);
val _ = print "\n"
